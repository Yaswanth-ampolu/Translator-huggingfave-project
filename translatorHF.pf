...
if __name__ == "__main__":
    ...
    translate_text_english_to_hindi(english_text)    # English to Hindi Translation

    hindi_text = "नमस्ते, आप कैसे हैं?"
    translate_text_hindi_to_english(hindi_text)   # hindi to English Translation

    spanish_text = "Hola, ¿cómo estás?"
    translate_text_spanish_to_english(spanish_text)   # spanish to English Translation

    german_text = "Guten Tag, wie geht es Ihnen?"
    translate_text_german_to_english(german_text)     # german to English Translation

    french_text = "Bonjour, comment ça va?"
    translate_text_french_to_english(french_text)    # french to English Translation

    chinese_text = "我爱你"
    translate_text_chinese_to_english(chinese_text)    # Chinese to English Translation
